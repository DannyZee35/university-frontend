...
import { getSingleCourse, updateFolderFeedback ,getLogsForCourse} from "../../features/courses/courseSlice";
...
export const FolderDetails = () => {
  ...
  const [folderCoordinatorFeedback, setFolderCoordinatorFeedback] = useState(singleCourse.FolderCoordinatorFeedback);
  const [isEditing, setIsEditing] = useState(false);
  
  const handleSubmit = async (e) => {
    e.preventDefault();
  
    const updatedFolderFeedbackData = {
      FolderCoordinatorFeedback: folderCoordinatorFeedback,
      status: status
    };
  
    console.log('handleSubmit called', id, updatedFolderFeedbackData);
  
    await dispatch(updateFolderFeedback({ id: id, updatedFolderFeedbackData: updatedFolderFeedbackData }));
    setIsEditing(false);
                  ...
                  {!isEditing && (
                    <>
                      ...
                      <Button
                        onClick={() => {
                          setIsEditing(true);
                          setFolderCoordinatorFeedback(singleCourse.FolderCoordinatorFeedback);
                        }}
                        variant="contained"
                        color="primary"
                        size="large"
